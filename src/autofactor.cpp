...
void AutoFactor(mpz_t N) {
    mpz_t b2p16, b2p100, b10p50, b10p100;
    mpz_init(b2p16); 	          mpz_init(b2p100);	             mpz_init(b10p50); 		         mpz_init(b10p100);
	mpz_set_ui(b2p16, 2);         mpz_set_ui(b2p100, 2);          mpz_set_ui(b10p50, 10);         mpz_set_ui(b10p100, 10);
	mpz_pow_ui(b2p16, b2p16, 16); mpz_pow_ui(b2p100, b2p100, 100); mpz_pow_ui(b10p50, b10p50, 50); mpz_pow_ui(b10p50, b10p50, 100); 
